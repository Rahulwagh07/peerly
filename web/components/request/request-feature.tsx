  ...
  const requestLoan = async ({
    ...
    try {
      ...
      handleCustomError({
        error,
        customError:
          'Failed to submit loan request. Make sure you have some SOL.',
      });
    }
  };
      ...
      <div className="p-4 relative mt-[4.5rem] lg:px-16">
        ...
        <MotionAnimation delay={0.1}>
          <CardHeader>
            ...
            <CardDescription>
              Submit your loan application and connect directly with Lenders on{' '}
              <br />
              our secure, blockchain-powered platform.
            </CardDescription>
          </CardHeader>
        </MotionAnimation>
        <CardContent>
